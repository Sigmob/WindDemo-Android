...
public class AdEntryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.bt_splash).setOnClickListener(v ->
                startActivity(new Intent(this, SplashAdActivity.class)));
        findViewById(R.id.bt_reward).setOnClickListener(v ->
                startActivity(new Intent(this, RewardVideoActivity.class)));
        findViewById(R.id.bt_new_interstitial).setOnClickListener(v ->
                startActivity(new Intent(this, NewInterstitialActivity.class)));
        findViewById(R.id.bt_native).setOnClickListener(v ->
                startActivity(new Intent(this, NativeAdActivity.class)));
        findViewById(R.id.bt_device).setOnClickListener(v ->
